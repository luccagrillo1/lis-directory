 ...
 *
 * LIS Directory — v0.43.1 (Checkout order review now has a × on each line so unwanted items can be removed without leaving checkout)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.43.1' );
