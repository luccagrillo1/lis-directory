 ...
 *
 * LIS Directory — v0.36.23 ("More Filters" is now a solid white chip instead of bare text, so it stays readable over hero photos)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.23' );
