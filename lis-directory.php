 ...
 *
 * LIS Directory — v0.36.36 (Vendor Showcase cards now use the same info-icon + Sponsored tooltip as the heading, instead of a plain SPONSORED badge)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.36' );
