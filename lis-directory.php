 ...
 *
 * LIS Directory — v0.35.3 (Business hours: a 'No set hours' toggle on the add/edit forms hides the grid and skips hours — for by-appointment businesses like insurance agents; clears any Google-prefilled hours)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.35.3' );
