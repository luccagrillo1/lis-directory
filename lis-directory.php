 ...
 *
 * LIS Directory — v0.36.18 (Ticker sits at its random start position the instant it appears — no flash-then-jump; track is hidden until the script positions it)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.18' );
