 ...
 *
 * LIS Directory — v0.36.2 (Retire the category-mirror entirely + add a cleanup tool that deletes the stray empty vendor categories and trashes the bloated per-category Showcase product, ahead of moving to a single Showcase product)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.2' );
