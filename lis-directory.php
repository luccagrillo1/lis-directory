 ...
 *
 * LIS Directory — v0.33.1 (Featured Listing product generator: a monthly/annual subscription ($19/mo, $190/yr) so Featured has a real annual price instead of one flat fee; repoints the Featured setting)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.33.1' );
