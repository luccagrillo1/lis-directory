 ...
 *
 * LIS Directory — v0.24.2 (switched Maps from the Embed API to the Maps JavaScript API + Geocoder, matching the API key that was actually provisioned)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.24.2' );
