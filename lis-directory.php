 ...
 *
 * LIS Directory — v0.36.40 (Listings pages no longer paginate — every published listing shows on one page, scroll instead of click through pages, on both the main archive and the [lis_listing_grid] "All Listings" pages)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.40' );
