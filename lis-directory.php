 ...
 *
 * LIS Directory — v0.30.2 (fork panel visual cleanup: title + "?" tooltip instead of always-visible description, tighter progress bar spacing, top padding fix for the no-banner page layout)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.30.2' );
