 ...
 *
 * LIS Directory — v0.23.1 (fixes a PHP syntax error in v0.23.0's Settings page — v0.23.0's zip was broken and its release was deleted, never installed anywhere)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.23.1' );
