 ...
 *
 * LIS Directory — v0.35.4 (Fix: the Vendor Showcase logo/business-card file inputs were hidden by the CSS that hides the multi-photo input — now only the photo input is hidden, so the logo/card uploads show)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.35.4' );
