 ...
 *
 * LIS Directory — v0.30.0 (real one-question-per-panel onboarding flow for Add Listing, with a Google-search-vs-manual fork up front)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.30.0' );
