 ...
 *
 * LIS Directory — v0.28.0 (real multi-step wizard for the Add Listing / Edit Listing forms, matching Directorist's own sidebar-step flow)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.28.0' );
