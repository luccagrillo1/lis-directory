 ...
 *
 * LIS Directory — v0.36.7 (Checkout: show the listing once as a clean "Listing: <name>" row instead of also gluing "— Featuring: <name>" onto the product name)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.7' );
