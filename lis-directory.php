 ...
 *
 * LIS Directory — v0.36.24 (Fixed the comment form on listing pages still saying "Leave a Reply"/"Comment" — Jetpack Comments' iframe wasn't picking up our review-form relabel)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.24' );
