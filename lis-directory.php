 ...
 *
 * LIS Directory — v0.36.25 (Widened the Jetpack Comments relabel fix — v0.36.24's domain-scoped gettext filter wasn't catching it live)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.25' );
