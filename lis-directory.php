 ...
 *
 * LIS Directory — v0.36.3 (Make the Showcase cleanup batched — trashes the product first, deletes empty vendor categories 40 at a time and auto-continues, so deleting ~228 terms no longer times out)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.3' );
