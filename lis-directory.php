 ...
 *
 * LIS Directory — v0.36.0 (Vendor Showcase categories now mirror the directory's listing categories automatically — added/renamed/deleted listing categories sync to lis_vendor_category, and the Showcase product tops up its variations for new ones)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.0' );
