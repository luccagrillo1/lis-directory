 ...
 *
 * LIS Directory — v0.36.35 (Wizard/card layout + spacing pass, map view now shows results below the map instead of hiding them, price filter hidden for now)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.35' );
