 ...
 *
 * LIS Directory — v0.36.13 (Tool to link every Vendor Showcase to its lis_listing + a Directorist-vs-LIS parity report on the settings page)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.13' );
