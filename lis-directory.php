 ...
 *
 * LIS Directory — v0.36.34 ([lis_listing_edit] is now a flat, all-fields-visible form instead of the step-by-step wizard, matching the wp-admin meta box's format)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.34' );
