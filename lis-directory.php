 ...
 *
 * LIS Directory — v0.31.12 (After a listing is submitted, show a dedicated thank-you screen in place of the wizard instead of a banner on top of the still-present form)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.31.12' );
