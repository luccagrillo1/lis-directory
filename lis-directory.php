 ...
 *
 * LIS Directory — v0.36.21 (Sponsored tooltip no longer clips off-screen on mobile — anchored to the icon instead of centered)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.21' );
