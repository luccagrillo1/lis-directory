 ...
 *
 * LIS Directory — v0.36.4 (Single-product Vendor Showcase: one Monthly/Annually subscription instead of hundreds of per-category variations; the category a buyer occupies is their listing's own category, exclusivity enforced in PHP; plan step shows a "this category is occupied" warning; tagline/logo/business card are now optional)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.4' );
