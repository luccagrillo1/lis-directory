 ...
 *
 * LIS Directory — v0.36.32 (Account "Listings" tab now correctly shows our dashboard, with Directorist-style filter tabs + Plan/Expiration columns)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.32' );
