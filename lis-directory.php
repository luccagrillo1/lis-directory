 ...
 *
 * LIS Directory — v0.21.0 (search/filter widget now embedded directly on the real /listings/ archive and category pages, not just the separate preview page)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.21.0' );
