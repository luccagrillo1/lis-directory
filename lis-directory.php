 ...
 *
 * LIS Directory — v0.35.2 (Claim: listing page now shows a compact 'Claim it' button instead of the full plan block; the block opens on a focused claim view (?claim=1) so it's not all on the listing page)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.35.2' );
