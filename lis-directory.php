 ...
 *
 * LIS Directory — v0.36.26 (temporary diagnostic build — gettext capture for the Jetpack Comments greeting, gated on ?lis_debug_gettext=1)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.26' );
