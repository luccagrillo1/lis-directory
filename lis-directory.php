 ...
 *
 * LIS Directory — v0.36.27 (Reordered single-listing sections: Claim/Report now come before Related/Reviews; Related manually placed via Jetpack's shortcode)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.27' );
