 ...
 *
 * LIS Directory — v0.45.0 (Featured is a flat $24/mo or $240/yr that includes Standard, and the private claim page no longer has an invisible white-on-white menu bar)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.45.0' );
