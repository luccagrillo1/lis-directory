 ...
 *
 * LIS Directory — v0.35.1 (HOTFIX: fatal on single-listing pages — the claim-box include had its closing brace after a line comment, commenting it out; fixed)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.35.1' );
