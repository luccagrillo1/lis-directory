 ...
 *
 * LIS Directory — v0.36.22 (Fixed a mobile flex-basis bug that made the search widget's fields balloon to 200px tall and push into the hero photo)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.22' );
