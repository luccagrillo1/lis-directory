 ...
 *
 * LIS Directory — v0.33.2 (Business-name step is now ONE box: Google autocomplete (new programmatic Places API) hangs a custom suggestions dropdown off the business-name input itself, instead of a separate Google search box above it)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.33.2' );
