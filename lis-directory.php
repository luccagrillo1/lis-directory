 ...
 *
 * LIS Directory — v0.43.0 (New one-click $1 Payment Test under Vendor Showcase: a private one-time test product that deletes itself after the payment goes through)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.43.0' );
