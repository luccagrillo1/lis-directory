 ...
 *
 * LIS Directory — v0.33.0 (Vendor Showcase folded into the one add-listing wizard: pick the Showcase plan to reveal its category slot + tagline + logo + business card; submit creates the pending vendor entry and hands off to the category-scoped subscription; payment auto-activates it. The whole application now lives in the single wizard.)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.33.0' );
