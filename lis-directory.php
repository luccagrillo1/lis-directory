 ...
 *
 * LIS Directory — v0.47.0 (Fully themeable through --lis-dir-* CSS custom properties that fall back to the site's brand tokens; see THEMING.md)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.47.0' );
