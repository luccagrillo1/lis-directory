 ...
 *
 * LIS Directory — v0.36.19 (Single-listing hero photo no longer crops — shows the whole photo, letterboxed on a neutral fill when it's a portrait/tall image)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.19' );
