 ...
 *
 * LIS Directory — v0.30.8 (removed Compare Listings - shortcode, "+ Compare" buttons, cookie-backed compare list, and all related CSS/JS)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.30.8' );
