 ...
 *
 * LIS Directory — v0.36.20 (Vendor Showcase heading gets a 'Sponsored' info tooltip and now links to a new browse-all Vendor Showcase page)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.20' );
