 ...
 *
 * LIS Directory — v0.36.28 (Related Posts now actually relocated client-side after Claim/Report; removed the temporary gettext diagnostic — Jetpack Comments relabel confirmed working)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.28' );
