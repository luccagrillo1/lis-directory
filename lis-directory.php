 ...
 *
 * LIS Directory — v0.42.0 (Plans are now single-select tiers that each include the ones below: Standard < Featured < Vendor Showcase, with Showcase carrying the Featured benefits)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.42.0' );
