 ...
 *
 * LIS Directory — v0.28.1 (Submit for Review now only shows on the wizard's last step, not every step — caught by live-testing the actual deployed v0.28.0)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.28.1' );
