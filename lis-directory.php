 ...
 *
 * LIS Directory — v0.30.9 (widen ticker vendor cards from 320px to 420px, matching the standalone Single Card's own width, so long names/taglines don't wrap onto extra lines and blow up the ticker's height)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.30.9' );
