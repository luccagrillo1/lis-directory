 ...
 *
 * LIS Directory — v0.27.0 (real rich-text editor for the description field, airier underline-input styling, taking design cues from Directorist's own multi-step form)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.27.0' );
