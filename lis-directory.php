 ...
 *
 * LIS Directory — v0.30.4 (correction: vertically center the wizard on the page, keep text left-aligned - 0.30.3 centered the wrong axis)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.30.4' );
