 ...
 *
 * LIS Directory — v0.36.8 (New [lis_preferred_vendor_top_category_card] shortcode: shows the showcase vendor for whichever category dominates the current search/archive results)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.8' );
