 ...
 *
 * LIS Directory — v0.36.1 (HOTFIX: the one-time category reconcile + per-category product regeneration was too heavy (233 cats, ~466 variations) and re-ran on every admin load, bogging down wp-admin. Removed those auto-ops; kept the lightweight live create/rename/delete category mirror.)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.1' );
