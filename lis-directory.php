 ...
 *
 * LIS Directory — v0.36.29 (Vendor Showcase offer button on listing pages; account page's Listings tab now shows the lis_listing dashboard instead of Directorist's)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.29' );
