 ...
 *
 * LIS Directory — v0.36.9 (Admin Listing Details meta box now edits branding/owner/plan/payment/expiry/Google link; logo auto-fills the listing image; business-card ticker fills its frame)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.9' );
