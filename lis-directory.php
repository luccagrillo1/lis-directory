 ...
 *
 * LIS Directory — v0.36.14 (Showcase ticker/cards now use the LINKED listing's logo, business card, and tagline — so editing the listing's branding updates the showcase; falls back to the vendor's own)
 */
...
define( 'LIS_DIRECTORY_VERSION', '0.36.14' );
